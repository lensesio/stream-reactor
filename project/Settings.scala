...
import Dependencies.{betterMonadicFor, globalExcludeDeps, googleProtobuf, googleProtobufJava, hadoopCommon, hadoopMapReduceClientCore, jsonSmart, nettyCodecSocks, nettyHandlerProxy, nimbusJoseJwt, woodstoxCore}
