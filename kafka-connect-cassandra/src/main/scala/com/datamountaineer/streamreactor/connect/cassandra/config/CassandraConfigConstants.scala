...
object CassandraConfigConstants {
  ...
  val AUTHENTICATION_MODE = "cassandra.authentication.mode"
  ...
  val EXPORT_TABLE_TOPIC_MAP = "cassandra.export.map"
  ...
  val TABLE_TIMESTAMP_COL_MAP = "cassandra.import.timestamp.column"
  ...
  val ASSIGNED_TABLES = "cassandra.assigned.tables"
