...
import com.datamountaineer.streamreactor.common.config.base.const.TraitConfigConst.{BATCH_SIZE_PROP_SUFFIX, CONSISTENCY_LEVEL_PROP_SUFFIX, ERROR_POLICY_PROP_SUFFIX, KCQL_PROP_SUFFIX, MAX_RETRIES_PROP_SUFFIX, PASSWORD_SUFFIX, PROGRESS_ENABLED_CONST, RETRY_INTERVAL_PROP_SUFFIX, THREAD_POLL_PROP_SUFFIX, USERNAME_SUFFIX}
