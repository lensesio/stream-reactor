...
import com.datamountaineer.streamreactor.common.config.base.traits.{BaseConfig, ConsistencyLevelSettings, ErrorPolicySettings, KcqlSettings, NumberRetriesSettings, ThreadPoolSettings}
