...
object KeyStoreUtils extends LazyLogging {
  ...
  def createKeystore(
    ...
    val _                         = KeyStoreUtils.createAndSaveKeystore(tmpDir, keyStorePassword, certificate, privateKey)
    val _                         = KeyStoreUtils.createAndSaveTruststore(tmpDir, trustStorePassword, certificate)
