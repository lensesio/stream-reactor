...
object HBaseConfig {
  ...
  val config: ConfigDef = new ConfigDef()
    ...
    .define(KCQL_QUERY, Type.STRING, Importance.HIGH, KCQL_QUERY, "Connection", 2, ConfigDef.Width.MEDIUM, KCQL_QUERY)
    .define(
      ERROR_POLICY,
      Type.STRING,
    ...
    .define(
      HBASE_CONFIG_DIR,
      Type.STRING,
      HBASE_CONFIG_DIR_DEFAULT,
      Importance.MEDIUM,
      HBASE_CONFIG_DIR_DOC,
      "Configs",
      1,
      ConfigDef.Width.MEDIUM,
      HBASE_CONFIG_DIR_DISPLAY,
    )
    //security
    .define(
      KerberosKey,
