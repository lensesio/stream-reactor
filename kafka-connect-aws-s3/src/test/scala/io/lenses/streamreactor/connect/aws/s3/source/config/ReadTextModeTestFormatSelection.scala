...
import io.lenses.streamreactor.connect.cloud.source.config.RegexReadTextMode
import io.lenses.streamreactor.connect.cloud.source.config.StartEndLineReadTextMode
import io.lenses.streamreactor.connect.cloud.source.config.StartEndTagReadTextMode
