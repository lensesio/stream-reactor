...
import io.lenses.streamreactor.connect.cloud.sink.config.KeyPartitionField
...
import io.lenses.streamreactor.connect.cloud.sink.config.ValuePartitionField
import io.lenses.streamreactor.connect.cloud.sink.config.WholeKeyPartitionField
