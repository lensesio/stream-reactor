...
import io.lenses.streamreactor.connect.aws.s3.source.files.BatchLister
import io.lenses.streamreactor.connect.aws.s3.source.files.DateOrderingBatchLister
import io.lenses.streamreactor.connect.aws.s3.source.files.DefaultOrderingBatchLister
