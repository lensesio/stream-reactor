...
class AuthModeSettingsTest {
  ...
  void testParseFromConfig_NoneAuthMode() {
    ...
    val configMap = new MapConnectConfig(Map.of(authModeSettings.getAuthModeKey(), "none"));
    val authMode = authModeSettings.parseFromConfig(configMap);
  ...
  void testParseFromConfig_DefaultAuthMode() {
    ...
    val configMap = new MapConnectConfig(Map.of(authModeSettings.getAuthModeKey(), "default"));
  ...
  void testParseFromConfig_UnsupportedAuthMode() {
    ...
    val configMap = new MapConnectConfig(Map.of(authModeSettings.getAuthModeKey(), "invalid"));
