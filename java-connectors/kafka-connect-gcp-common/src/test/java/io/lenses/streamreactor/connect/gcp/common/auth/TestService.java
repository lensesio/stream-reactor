...
class TestSvcServiceOptions extends ServiceOptions<TestService, TestSvcServiceOptions> {
  ...
  protected TestSvcServiceOptions(
      Class<? extends ServiceFactory<TestService, TestSvcServiceOptions>> serviceFactoryClass,
      Class<? extends ServiceRpcFactory<TestSvcServiceOptions>> rpcFactoryClass,
      Builder<TestService, TestSvcServiceOptions, ?> builder,
      ServiceDefaults<TestService, TestSvcServiceOptions> serviceDefaults) {
...
class TestSvcServiceOptionsBuilder
    extends ServiceOptions.Builder<TestService, TestSvcServiceOptions, TestSvcServiceOptionsBuilder> {
