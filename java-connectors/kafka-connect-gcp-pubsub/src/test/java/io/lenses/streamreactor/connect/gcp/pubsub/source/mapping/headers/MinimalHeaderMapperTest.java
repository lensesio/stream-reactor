...
class MinimalHeaderMapperTest {
  ...
  private MinimalHeaderMapper minimalHeaderMapping;

  @BeforeEach
  void setup() {
    minimalHeaderMapping = new MinimalHeaderMapper();
  }
  ...
  void testGetHeaders() {
    ...
    Map<String, String> result = minimalHeaderMapping.mapHeaders(pubSubMessageData);
