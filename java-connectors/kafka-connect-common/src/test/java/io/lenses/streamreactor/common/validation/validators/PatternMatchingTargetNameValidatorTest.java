...
class PatternMatchingTargetNameValidatorTest {
  ...
  @Test
  void validateShouldReturnEmptyErrorListIfTargetTopicMatchesRegexp() {
    //given
    PatternMatchingTargetNameValidator validator =
        new PatternMatchingTargetNameValidator(ONLY_LETTERS_REGEXP, ERROR_MESSAGE_FUNCTION);
  ...
  @Test
  void validateShouldReturnListWithErrorIfTargetTopicDoesntMatchRegexp() {
    //given
    String errorString = "ERROR";
    PatternMatchingTargetNameValidator validator =
        new PatternMatchingTargetNameValidator(ONLY_LETTERS_REGEXP, ERROR_MESSAGE_FUNCTION);
    Kcql invalidKcql = Kcql.parse("INSERT INTO a1bc SELECT * FROM def");
