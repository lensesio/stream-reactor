...
class AzureServiceBusSinkConnectorTest {

  private static final String CONFIG_CONNECTOR_NAME = "AzureServiceBusSinkConnector";
  ...
  void taskClassShouldReturnTaskClass() {
    ...
    //then
    assertEquals(AzureServiceBusSinkTask.class, taskClass);
  }
  ...
  void configShouldReturnConfigClass() {
    ...
    //then
    assertEquals(AzureServiceBusSinkConfig.getConfigDefinition(), configDef);
  }
