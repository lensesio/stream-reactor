...
object ReThinkSinkConfig {
  val config: ConfigDef = new ConfigDef()
    .define(ReThinkSinkConfigConstants.RETHINK_HOST, Type.STRING, ReThinkSinkConfigConstants.RETHINK_HOST_DEFAULT,
    ...
    .define(ReThinkSinkConfigConstants.RETHINK_DB, Type.STRING, ReThinkSinkConfigConstants.RETHINK_DB_DEFAULT,
    ...
    .define(ReThinkSinkConfigConstants.RETHINK_PORT, Type.INT, ReThinkSinkConfigConstants.RETHINK_PORT_DEFAULT,
    ...
    .define(ReThinkSinkConfigConstants.ERROR_POLICY, Type.STRING, ReThinkSinkConfigConstants.ERROR_POLICY_DEFAULT,
    ...
    .define(ReThinkSinkConfigConstants.ERROR_RETRY_INTERVAL, Type.INT, ReThinkSinkConfigConstants.ERROR_RETRY_INTERVAL_DEFAULT,
    ...
    .define(ReThinkSinkConfigConstants.NBR_OF_RETRIES, Type.INT, ReThinkSinkConfigConstants.NBR_OF_RETIRES_DEFAULT,
    ...
    .define(ReThinkSinkConfigConstants.BATCH_SIZE, Type.INT, ReThinkSinkConfigConstants.BATCH_SIZE_DEFAULT, Importance.MEDIUM,
