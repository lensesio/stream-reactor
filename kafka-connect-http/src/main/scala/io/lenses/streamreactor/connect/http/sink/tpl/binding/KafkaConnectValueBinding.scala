...
class KafkaConnectValueBinding(name: Option[String]) extends KafkaConnectBaseBinding() {
  override def get(sinkRecord: SinkRecord): AnyRef =
    KafkaConnectExtractor.extractFromValue(sinkRecord, name).leftMap(e =>
