...
object JMSConfig {
  ...
  val config: ConfigDef = new ConfigDef()
    ...
    .define(JMSConfigConstants.DEFAULT_SOURCE_CONVERTER_CONFIG, Type.STRING, "", Importance.HIGH, JMSConfigConstants.DEFAULT_SOURCE_CONVERTER_DOC,
        "Converter", 1, ConfigDef.Width.MEDIUM, JMSConfigConstants.DEFAULT_SOURCE_CONVERTER_DISPLAY)
