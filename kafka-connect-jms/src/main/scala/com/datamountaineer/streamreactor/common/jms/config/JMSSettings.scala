...
package com.datamountaineer.streamreactor.common.jms.config
...
import com.datamountaineer.streamreactor.common.jms.config.DestinationSelector.DestinationSelector
