...
import com.datamountaineer.streamreactor.connect.config.base.traits.{BaseConfig, KcqlSettings}
...
/**
  ...
  **/
case class DruidConfig(props: util.Map[String, String])
  extends BaseConfig(DruidSinkConfigConstants.CONNECTOR_PREFIX, DruidConfig.config, props)
  with KcqlSettings
