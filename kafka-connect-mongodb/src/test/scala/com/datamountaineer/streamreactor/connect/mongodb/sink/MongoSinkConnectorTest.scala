...
class MongoSinkConnectorTest extends WordSpec with Matchers {
  "MongoSinkConnector" should {
    ...
    "return 2 configs when 3 routes are provided and maxTasks is 2" in {
      ...
      tasksConfigs(0).get(MongoConfigConstants.KCQL_CONFIG) shouldBe "INSERT INTO collection1 SELECT * FROM topic1;INSERT INTO coll2 SELECT * FROM topicA"
      tasksConfigs(1).get(MongoConfigConstants.KCQL_CONFIG) shouldBe "INSERT INTO coll3 SELECT * FROM topicB"
    }
    ...
    "return 3 configs when 3 routes are provided and maxTasks is 3" in {
      ...
      tasksConfigs(0).get(MongoConfigConstants.KCQL_CONFIG) shouldBe "INSERT INTO collection1 SELECT * FROM topic1"
      tasksConfigs(1).get(MongoConfigConstants.KCQL_CONFIG) shouldBe "INSERT INTO coll2 SELECT * FROM topicA"
      tasksConfigs(2).get(MongoConfigConstants.KCQL_CONFIG) shouldBe "INSERT INTO coll3 SELECT * FROM topicB"
    }
    ...
    "return 2 configs when 4 routes are provided and maxTasks is 2" in {
      ...
      tasksConfigs.length shouldBe 2
      tasksConfigs(0).get(MongoConfigConstants.KCQL_CONFIG) shouldBe "INSERT INTO collection1 SELECT * FROM topic1;INSERT INTO coll2 SELECT * FROM topicA"
      tasksConfigs(1).get(MongoConfigConstants.KCQL_CONFIG) shouldBe "INSERT INTO coll3 SELECT * FROM topicB;INSERT INTO coll4 SELECT * FROM topicC"
    }
  }
}
