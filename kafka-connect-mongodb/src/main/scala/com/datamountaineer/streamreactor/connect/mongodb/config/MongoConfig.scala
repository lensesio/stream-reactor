...
import com.datamountaineer.streamreactor.common.config.base.traits.{BaseConfig, DatabaseSettings, ErrorPolicySettings, KcqlSettings, NumberRetriesSettings, UserSettings}
