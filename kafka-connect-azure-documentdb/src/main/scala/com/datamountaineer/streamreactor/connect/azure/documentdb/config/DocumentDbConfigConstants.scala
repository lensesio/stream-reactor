...
import com.datamountaineer.streamreactor.connect.config.base.const.TraitConfigConst.{CONSISTENCY_LEVEL_PROP_SUFFIX, DATABASE_PROP_SUFFIX, ERROR_POLICY_PROP_SUFFIX, KCQL_PROP_SUFFIX, MAX_RETRIES_PROP_SUFFIX, PROGRESS_ENABLED_CONST, RETRY_INTERVAL_PROP_SUFFIX}
