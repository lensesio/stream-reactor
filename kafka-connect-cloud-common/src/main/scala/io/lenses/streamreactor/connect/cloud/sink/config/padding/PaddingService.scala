...
import io.lenses.streamreactor.connect.cloud.config.kcqlprops.S3PropsKeyEnum.PaddingCharacter
import io.lenses.streamreactor.connect.cloud.config.kcqlprops.S3PropsKeyEnum.PaddingLength
import io.lenses.streamreactor.connect.cloud.config.kcqlprops.S3PropsKeyEnum.PaddingSelection
