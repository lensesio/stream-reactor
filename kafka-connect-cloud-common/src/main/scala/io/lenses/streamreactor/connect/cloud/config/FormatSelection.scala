...
import io.lenses.streamreactor.connect.cloud.config.kcqlprops.S3PropsKeyEntry
...
import io.lenses.streamreactor.connect.cloud.formats.reader.converters.TextConverter
...
import io.lenses.streamreactor.connect.cloud.formats.reader.CsvStreamReader
...
import io.lenses.streamreactor.connect.cloud.formats.reader.TextStreamReader
import io.lenses.streamreactor.connect.cloud.model.CompressionCodecName._
import io.lenses.streamreactor.connect.cloud.model.CompressionCodecName
...
import io.lenses.streamreactor.connect.cloud.source.config.ReadTextMode
