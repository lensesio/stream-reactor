 ...
 */
package io.lenses.streamreactor.connect.cloud.sink.conversion

import io.lenses.streamreactor.connect.cloud.formats.writer.ArraySinkData
import io.lenses.streamreactor.connect.cloud.formats.writer.BooleanSinkData
import io.lenses.streamreactor.connect.cloud.formats.writer.ByteArraySinkData
import io.lenses.streamreactor.connect.cloud.formats.writer.ByteSinkData
import io.lenses.streamreactor.connect.cloud.formats.writer.DoubleSinkData
import io.lenses.streamreactor.connect.cloud.formats.writer.FloatSinkData
import io.lenses.streamreactor.connect.cloud.formats.writer.IntSinkData
import io.lenses.streamreactor.connect.cloud.formats.writer.LongSinkData
...
import io.lenses.streamreactor.connect.cloud.formats.writer.ShortSinkData
